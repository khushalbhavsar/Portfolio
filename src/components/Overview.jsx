  ...
  return (
    <section id="overview">
      ...
      >
        ...
        <p className="text-sm sm:text-base text-slate-600 dark:text-slate-300 leading-relaxed">
            I'm <b>Khushal Bhavsar</b>, an <b>AWS Certified Solutions Architect – Associate</b> and a DevOps & Cloud enthusiast with a strong engineering foundation and hands-on experience in building automated, scalable, and secure infrastructure. I completed my <b>B.Tech in Electronics and Telecommunication Engineering</b> from <b>KDK College of Engineering, Nagpur (2021–2025)</b> with a <b>CGPA of 8.0</b>. I have <b>successfully completed my DevOps Internship at Cloudnautic</b>, where I worked on real-world AWS projects, automated CI/CD pipelines using <b>Jenkins and GitHub Actions</b>, implemented <b>Infrastructure as Code</b> with <b>Terraform and CloudFormation</b>, and deployed containerized applications using <b>Docker and Kubernetes (EKS)</b>. I have strong technical skills in <b>Linux, Git, AWS, Kubernetes, Terraform, Docker</b>, and monitoring tools like <b>CloudWatch, Prometheus, and Grafana</b>. I am passionate about simplifying infrastructure, improving automation, and building reliable, scalable, and production-ready systems.
        </p>
